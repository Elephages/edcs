...
let ultimateOne1 = document.getElementById("ultimateOne1");
let ultimateTwo1 = document.getElementById("ultimateTwo1");
let ultimateThree1 = document.getElementById("ultimateThree1");
let ultimateFour1 = document.getElementById("ultimateFour1");
let ultimateOne2 = document.getElementById("ultimateOne2");
let ultimateTwo2 = document.getElementById("ultimateTwo2");
let ultimateThree2 = document.getElementById("ultimateThree2");
let ultimateFour2 = document.getElementById("ultimateFour2");
...
let protected1 = document.getElementById("protected1");
let protected2 = document.getElementById("protected2");
...
function loadSets(onlyFirst = true, onlySecond = true) {
...
function calculateDamage(moveOne1, moveTwo1, moveThree1, moveFour1, moveOne2, moveTwo2, moveThree2, moveFour2, soulMove1, soulMove2) {
	...
	let ultOne1 = ultimateOne1.checked;
	let ultTwo1 = ultimateTwo1.checked;
	let ultThree1 = ultimateThree1.checked;
	let ultFour1 = ultimateFour1.checked;
	let ultOne2 = ultimateOne2.checked;
	let ultTwo2 = ultimateTwo2.checked;
	let ultThree2 = ultimateThree2.checked;
	let ultFour2 = ultimateFour2.checked;
    ...
    let dmgMoveOneU1 = getMultiplier(firstLoom, secondLoom, moveOne1, moveOnePower1.value, critOne1, ultOne1, repeat1, hitsOne1, swarmOne1, snowballOne1, false, level1.value);
    let dmgMoveOneL1 = getMultiplier(firstLoom, secondLoom, moveOne1, moveOnePower1.value, critOne1, ultOne1, repeat1, hitsOne1, swarmOne1, snowballOne1, false, level1.value, true);
    ...
    let dmgMoveTwoU1 = getMultiplier(firstLoom, secondLoom, moveTwo1, moveTwoPower1.value, critTwo1, ultTwo1, repeat1, hitsTwo1, swarmTwo1, snowballTwo1, false, level1.value);
    let dmgMoveTwoL1 = getMultiplier(firstLoom, secondLoom, moveTwo1, moveTwoPower1.value, critTwo1, ultTwo1, repeat1, hitsTwo1, swarmTwo1, snowballTwo1, false, level1.value, true);
    ...
    let dmgMoveThreeU1 = getMultiplier(firstLoom, secondLoom, moveThree1, moveThreePower1.value, critThree1, ultThree1, repeat1, hitsThree1, swarmThree1, snowballThree1, false, level1.value);
    let dmgMoveThreeL1 = getMultiplier(firstLoom, secondLoom, moveThree1, moveThreePower1.value, critThree1, ultThree1, repeat1, hitsThree1, swarmThree1, snowballThree1, false, level1.value, true);
    ...
    let dmgMoveFourU1 = getMultiplier(firstLoom, secondLoom, moveFour1, moveFourPower1.value, critFour1, ultFour1, repeat1, hitsFour1, swarmFour1, snowballFour1, false, level1.value);
    let dmgMoveFourL1 = getMultiplier(firstLoom, secondLoom, moveFour1, moveFourPower1.value, critFour1, ultFour1, repeat1, hitsFour1, swarmFour1, snowballFour1, false, level1.value, true);
    ...
    let dmgSoulMoveOneU1 = getMultiplier(firstLoom, secondLoom, soulMove1, soulMovePower1, critOne1, undefined, undefined, undefined, undefined, undefined, false, level1.value);
    let dmgSoulMoveOneL1 = getMultiplier(firstLoom, secondLoom, soulMove1, soulMovePower1, critOne1, undefined, undefined, undefined, undefined, undefined, false, level1.value, true);
    ...
    let dmgMoveOneU2 = getMultiplier(secondLoom, firstLoom, moveOne2, moveOnePower2.value, critOne2, ultOne2, repeat2, hitsOne2, swarmOne2, snowballOne2, false, level2.value, undefined, true);
    let dmgMoveOneL2 = getMultiplier(secondLoom, firstLoom, moveOne2, moveOnePower2.value, critOne2, ultOne2, repeat2, hitsOne2, swarmOne2, snowballOne2, false, level2.value, true, true);
    ...
    let dmgMoveTwoU2 = getMultiplier(secondLoom, firstLoom, moveTwo2, moveTwoPower2.value, critTwo2, ultTwo2, repeat2, hitsTwo2, swarmTwo2, snowballTwo2, false, level2.value, undefined, true);
    let dmgMoveTwoL2 = getMultiplier(secondLoom, firstLoom, moveTwo2, moveTwoPower2.value, critTwo2, ultTwo2, repeat2, hitsTwo2, swarmTwo2, snowballTwo2, false, level2.value, true, true);
    ...
    let dmgMoveThreeU2 = getMultiplier(secondLoom, firstLoom, moveThree2, moveThreePower2.value, critThree2, ultThree2, repeat2, hitsThree2, swarmThree2, snowballThree2, false, level2.value, undefined, true);
    let dmgMoveThreeL2 = getMultiplier(secondLoom, firstLoom, moveThree2, moveThreePower2.value, critThree2, ultThree2, repeat2, hitsThree2, swarmThree2, snowballThree2, false, level2.value, true, true);
    ...
    let dmgMoveFourU2 = getMultiplier(secondLoom, firstLoom, moveFour2, moveFourPower2.value, critFour2, ultFour2, repeat2, hitsFour2, swarmFour2, snowballFour2, false, level2.value, undefined, true);
    let dmgMoveFourL2 = getMultiplier(secondLoom, firstLoom, moveFour2, moveFourPower2.value, critFour2, ultFour2, repeat2, hitsFour2, swarmFour2, snowballFour2, false, level2.value, true, true);
    ...
    let dmgSoulMoveTwoU2 = getMultiplier(secondLoom, firstLoom, soulMove2, soulMovePower2, critOne2, undefined, undefined, undefined, undefined, undefined, false, level2.value, undefined, true);
    let dmgSoulMoveTwoL2 = getMultiplier(secondLoom, firstLoom, soulMove2, soulMovePower2, critOne2, undefined, undefined, undefined, undefined, undefined, false, level2.value, true, true);
...
function detailedReport() {
    ...
    if (move.power == 0 || (move.name == "Spit Out" && playerItem == "None") || (guarded && !ult)) {
    ...
    let possibleArray = getMultiplier(firstLoom, secondLoom, move, movePower, crit, ult, repeat, hits, swarm, snowball, false, level, undefined, second, true);
	...
	let superMove = ( ult ? stuffUsed.ult : move.name);
    ...
    possibleArray = getMultiplier(firstLoom, secondLoom, move, movePower, crit, ult, repeat, hits, swarm, snowball, false, level, undefined, second, true, false, counter);
...
function getMultiplier(loom1, loom2, move, movePower, crit, ult, repeat, hits, swarm, snowball, hitConfirmer = false, level, ul = false, second = false, detailed = false, withoutSlapDown = true, takeSecondaryType = false, foulHit = false) {
    let guarded = (second == false ? protected2.checked : protected1.checked);  
	if ((move.power == 0 || (guarded && !ult)) && detailed) return [0];
    if (move.power == 0 || (guarded && !ult)) return 0;
    ...
    let possibleDmg = [];
    let possibleFoulDmg;
    let stuffUsed = { ability1: "", ability2: "", item1: "", item2: "", extra1: "", extra2: "", weather: "", ult: ""};
    let adaptive = { mr: "", mr1: "", mr2: ""};


    let immuneBoostCheck1 = (second == false ? immuneAbilityBoost1.checked : immuneAbilityBoost2.checked);
	if (ult) {
		if (loom1.ult && tempName == loom1.ult[0]) {
			tempName = loom1.ult[1];
			tempPower = loom1.ult[2];
		} else {
			tempName = types[tempType.toLowerCase()].ultName;
			tempPower = (tempPower <= 55 ? 100 : tempPower > 55 && tempPower <= 65 ? 120 : tempPower > 65 && tempPower <= 75 ? 140 : tempPower > 75 && tempPower <= 85 ? 160 : tempPower > 85 && tempPower <= 95 ? 160 : tempPower > 95 && tempPower < 100 ? 175 : tempPower == 100 ? 180 : tempPower > 100 && tempPower <= 110 ? 185 : tempPower > 110 && tempPower <= 125 ? 190 : tempPower > 125 && tempPower <= 130 ? 195 : 200);
		}
		ability1 = "None";
		stuffUsed.extra1 += " (" + tempPower + " BP)";
		stuffUsed.ult = tempName;
	}
    
    if (tempName.includes("Special Attack") || tempName == "Last Resort" || tempName == "Special Serving") {
    ...
    tempPower = (tempName == "Trip Root" ? getTripRootPower(loom2.weight) : tempPower);


    if (tempName == "Trip Root") {
    ...
    if (tempName == "Somniloquy" && stat1 != "asleep") {
    ...
    if (tempName == "Spit Out" && ((itemA.includes("Shell")) || (itemA.includes("Essence")) || (itemA.includes("Pearl"))) && withoutSlapDown && !foulHit) {
    ...
    if ((tempName == "Oppress" && stat2 != "healthy") ||
       ((tempName == "Torment" || tempName == "Splitting Headache") && stat1 != "healthy")) {
        powerCheck *= 2;
        multi *= 2;
    ...
    if (tempName == "Rough Up" && loom1.height > loom2.height) {
        powerCheck *= 1.25;
        multi *= 1.25;
        stuffUsed.extra1 += " (" + Math.floor(tempPower * 1.25) + " BP)";
    }

    if (tempName == "Climate Cannon" && !noWeather.checked) {
   ...
   if (ability2 != "Spectrum Plate" && ability1 == "Power Buster") {
        ability2 = "None";
    ...
    if (tempName == "Power Drill" && loom2.types.includes("Earth")) stuffUsed.ability1 = ability1;
    ...
    if (tempName == "Gloominous Roar" && ability1 == "Circadian" && types1.secondary != "None" && types1.secondary != undefined) {
    ...
    if (tempName == "Flare" && (parseInt(stats1.spd) > parseInt(stats2.spd) || btl1)) {
        multi *= 2;
        stuffUsed.extra1 += " (" + tempPower * 2 + " BP)";
    }

    if (tempName == "Thousand Cuts") {
    ...
    if ((ability1 == "Ambush" && btl1 && withoutSlapDown && tempName != "Chase Down") ||
...
if (ability1 == "Triple Threat" && (tempType == "Electric" || tempType == "Pyro" || tempType == "Hydro")) {
   ...
   if ((ability1 == "Sharp Teeth" && move.bite == true) ||
    ...
    if (isStab(types1, { type: tempType }) && ability1 == "Adaptable") {
        multi *= 2;
        stuffUsed.ability1 = ability1;
    }
    else if (isStab(types1, { type: tempType }) || ability1 == "Adaptable") {
        multi *= 1.5;
        if (ability1 == "Adaptable") stuffUsed.ability1 = ability1;
    }
    ...
    else if (tempName == "Frost Burn" && loom1.name == "Tiklipse") {
        multi *= 1.5;
    }
    ...
    if (types[types2.primary.toLowerCase()].immunities.includes(tempType.toLowerCase()) && !(tempName == "Power Drill" && tempType == "Electric")) {
        multi *= 0;
    }
    if (types2.secondary != "None" && types[types2.secondary.toLowerCase()].immunities.includes(tempType.toLowerCase()) && !(tempName == "Power Drill" && tempType == "Electric")) {
        multi *= 0;
    }
    ...
    if (stat1 == "burned" && move.mr == "Melee" && tempName != "Torment" && ability1 != "Vigorous" && ability1 != "Water Membrane" && types1.primary != "Pyro" && types1.secondary != "Pyro" && !(adaptive.mr && adaptive.mr == "Ranged")) {
        multi *= 0.5;
    }

	
     if (stat1 == "freeze" && move.mr == "Magic" && tempName != "Torment" && ability1 != "Vigorous" && types1.primary != "Ice" && types1.secondary != "Ice" && !(adaptive.mr && adaptive.mr == "Ranged")) {
        multi *= 0.5;
    }
...
if (itemB == "Crystal Medallion") {
	...
	if (effectiveness > 1 && ability2 == "Spectrum Plate") {
        multi *= 0.75;
        stuffUsed.ability2 = ability2;
    }
	if (guarded && ult) {
		multi *= 0.25;
		stuffUsed.weather += " through Guard Up";
	}
    ...
    if (ability1 == "Double Strike" && !foulHit && !(isDouble && move.aoe == true) && !move.hits) {
        if (detailed) {
            let foulArray = getMultiplier(loom1, loom2, move, movePower, crit, ult, repeat, hits, swarm, snowball, false, level, ul, second, detailed, withoutSlapDown, takeSecondaryType, true);
            foulDmg = foulArray[0];
            possibleFoulDmg = foulArray[1];
        } else {
            foulDmg = getMultiplier(loom1, loom2, move, movePower, crit, ult, repeat, hits, swarm, snowball, false, level, ul, second, detailed, withoutSlapDown, takeSecondaryType, true);
        }
        stuffUsed.ability1 = ability1;
    }
    ...
    let multiDmg = 0;
    if (move.hits && !hitConfirmer && !ult) {
        hits = hits.charAt(0);
        if (tempName == "Tail Lash" || tempName == "Bi-Icicle" || tempName == "Laser Eyes" ) hits = 2;
        
        for (let i = 0; i < hits - 1; i++) {
            multiDmg = multiDmg + getMultiplier(loom1, loom2, move, movePower, crit, ult, repeat, hits, swarm, snowball, true, level, ul, second, detailed, false);
        }
    ...
    if (detailed && !hitConfirmer) {
        ...
        let multiHits = 1;
        if (move.hits && !ult) {
            if (tempName == "Laser Eyes" || tempName == "Tail Lash") hits = 2;
            if (tempName == "Bi-Icicle") hits = 2;
