var loomians = {
  ...
  fowlous: {
    ...
    flarin: {
        ...
        number: 04,
        types: ["Pyro"],
        abilities: ["Thermal Power"],
        sAbility: ["Victory Lap"],
        finalEvo: false,
        weight: 39,
        height: 59,
        baseStats: {
    ...
    bombossic: {
        ...
        abilities: ["Thermal Power"],
        sAbility: ["Victory Lap"],
		ult: ["Burning Bite", "Wheele of Fire", 180],
        finalEvo: true,
        weight: 39,
        height: 59,
        baseStats: {
   ...
   paraceit: {
        ...
        number: 16,
        types: ["Dark", "Bug"],
        abilities: ["Blood Drinker"],
        sAbility: ["Incompatible"],
        finalEvo: false,
        weight: 39,
        height: 59,
        baseStats: {
	...
	glaeshave: {
        ...
        number: 40,
        types: ["Ice", "martial"],
        abilitiess: ["Soft Served", "High Reign"],
        finalEvo: true,
        weight: 39,
        height: 59,
        baseStats: {
   ...
   craymor: {
	...
	kideer: {
        ...
        number: 117,
        types: ["Basic"],
        abilities: ["Honor Guard"],
		sAbility: ["Self Healing"],
        finalEvo: false,
        weight: 39,
        height: 59,
        baseStats: {
...
var types = {
    ...
    pyro:  {
        weaknesses:  ["hydro", "wind", "geo", "mystic"],
        resistances:  ["pyro", "nature", "ice", "metal", "bug"],
        immunities:  [],
        ultName: "Pyro Ult"
    },
    ...
    nature:  {
        weaknesses:  ["pyro", "wind", "ice", "dark", "toxic", "bug"],
        resistances:  ["nature", "hydro", "geo", "electric", "mystic"],
        immunities:  ["light"],
        ultName: "Nature Ult"
    },
    ...
    electric:  {
        ...
        immunities:  [],
        ultName: "Electric Ult"
    },
	
    martial:  {
        weaknesses:  ["psychic", "toxic", "wind"],
        resistances:  ["mystic", "dark"],
        immunities:  [],
        ultName: "Martial Ult"
    },
    ...
    metal:  {
        ...
        resistances:  ["basic", "nature", "metal", "wind", "mystic", "psychic", "ice", "bug"],
        immunities:  ["toxic"],
        ultName: "Metal Ult"
    },
    ...
    wind:  {
        ...
        resistances:  ["martial", "nature", "bug"],
        immunities:  ["geo"],
        ultName: "Wind Ult"
    },
    ...
    toxic:  {
        ...
        resistances:  ["toxic", "nature", "martial", "bug"],
        immunities:  [],
        ultName: "Toxic Ult"
    },

    dark:  {
        weaknesses:  ["light", "bug", "martial"],
    ...
    mystic:  {
        weaknesses:  ["nature", "toxic", "mystic", "metal"],
        resistances:  ["pyro", "hydro", "soul", "electric"],
        immunities:  [],
        ultName: "Mystic Ult"
    },
	
	bug:  {
        weaknesses:  ["pyro", "wind", "ice"],
        resistances:  ["martial", "nature", "toxic", "bug", "dark", "geo"],
        immunities:  [],
        ultName: "Bug Ult"
    },
...
var abilities = [
	...
	"High Reign", "High Velocity", "Honor Guard","Hydrate", "Hydration", "Hydrodynamic", "Hyper Cannon", "Blood Rush", "Specialist", "Poisonous", "Rigid", "Tunnel Vision",
	...
	, "Sadistic", "Snowfall", "Spirit Affinity", "Starfall", "Stalker", "Supercharged", "Superconductor", "Slugger", "Slasher","Shell Armor", "Power Buster", "Plague", "Spooky",
